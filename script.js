...
192.168.1.100
Если же ответ в ином формате, то пропишите в файле hosts, расположенному в папке "C:\Windows\System32\drivers\etc", строку:
192.168.1.100  NVR-1
,где 192.168.1.100 - адрес вашего сервера, а NVR-1 - имя вашего сервера.
3) и на сервере и на клиентском ПК в брандмауэре разрешены входящие и исходящие подключения для портов, указаных в "Руководстве администратора" Приложение 5. 
Как вариант для проверки можно просто отключить брандмауер.`
